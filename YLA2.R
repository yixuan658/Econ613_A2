...
all = sum(share)
mks_pro = share/all #market share by product
View(mks_pro)
...
colnames(ch_all) = c("hhid","product","choice")
ex1.3 = matrix(cbind(hhidd,income),ncol = 2)
colnames(ex1.3) = c("hhid","choice")
ch_s = merge(ch_all,ex1.3,by="hhid",all = T, sort = T)
...
map = cbind(i,map)
colnames(map) = c("income level","product1","product2","product3","product4","product5","product6","product7","product8","product9","product10")
View(map)
